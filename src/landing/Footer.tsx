const footerLinks = {
  ...
  Solutions: ['For Startups', 'For Enterprise', 'For Marketing', 'For Engineering', 'For Operations'],
  Resources: ['Documentation', 'Blog', 'Templates', 'Community', 'Webinars', 'API Reference'],
  Company: ['About', 'Careers', 'Press Kit', 'Partners', 'Contact', 'Legal'],
};
    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              The all-in-one workflow automation platform for modern teams.
            </p>
            {/* Social links */}
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm">© 2026 FlowSync, Inc. All rights reserved.</p>
